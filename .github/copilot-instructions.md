# Copilot Instructions – Zizo Academy Web

This file defines **mandatory coding standards and AI behavior rules** for the Zizo Academy Web project.
...
export default function UserProfile() {
  ...
  const [userProfileInfo, setUserProfileInfo] = useState<UserProfileData | null>(null);
